...
write.csv(df_exp, "Big_pilot_4(dot_reference_first)/df_exp.csv", row.names=FALSE)
write.csv(df_NotExperimentData, "Big_pilot_4(dot_reference_first)/df_NotExperimentData.csv", row.names=FALSE)
