...
# data
content<-readLines(root$find_file("pilot_5(ref52_aq_ref52)/jatos_results_20240320124117.txt"))
res<-lapply(content,fromJSON)

# load the function to read the .txt results from JATOS and create a dataframe
source(root$find_file("pilot_5(ref52_aq_ref52)/initial_df_pilot.R"))
...
write.csv(df_exp, "pilot_5(ref52_aq_ref52)/df_exp.csv", row.names=FALSE)
write.csv(df_NotExperimentData, "pilot_5(ref52_aq_ref52)/df_NotExperimentData.csv", row.names=FALSE)
