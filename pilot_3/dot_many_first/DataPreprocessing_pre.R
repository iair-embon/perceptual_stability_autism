...
write.csv(df_exp_filtered_mod, "pilot_3/dot_many_first/df_exp_filtered_mod.csv", row.names=FALSE)
write.csv(df_NotExperimentData, "pilot_3/dot_many_first/df_NotExperimentData.csv", row.names=FALSE)
